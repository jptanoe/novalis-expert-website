...
function Navbar({ active, onNav }) {
  ...
  return (
    <nav style={{ position:"fixed", top:0, left:0, right:0, zIndex:1000, background:scrolled?"rgba(0,20,60,0.97)":"transparent", backdropFilter:scrolled?"blur(20px)":"none", borderBottom:scrolled?"1px solid rgba(212,160,23,0.2)":"none", transition:"all 0.3s" }}>
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"0 24px", display:"flex", alignItems:"center", justifyContent:"space-between", height:72 }}>
        <div onClick={()=>onNav("accueil")}><Logo size={36} light/></div>
...
function Hero({ onNav }) {
  return (
    <section id="accueil" style={{ minHeight:"100vh", background:"linear-gradient(145deg,#000f2e 0%,#001d52 40%,#002B6B 70%,#003580 100%)", display:"flex", alignItems:"center", position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ maxWidth:1280, margin:"0 auto", padding:"110px 28px 80px", width:"100%", position:"relative", zIndex:1 }}>
  ...
  return (
    <section id="entreprises" style={{ background:"#F5F7FA", padding:"90px 28px" }}>
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:22, marginBottom:46 }}>
          {[
...
function FDFPSection() {
  ...
  return (
    <section id="fdfp" style={{ background:"white", padding:"90px 28px" }}>
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:62, alignItems:"flex-start" }}>
          <div>
      ...
      <div style={{ maxWidth:1100, margin:"0 auto" }}>
        ...
        <div style={{ borderRadius:14, overflow:"hidden", border:"1px solid rgba(255,255,255,0.1)", marginBottom:50 }}>
          ...
          {[
            ...
            <div key={i} style={{ display:"grid", gridTemplateColumns:"1.8fr 1fr 1fr", borderBottom:"1px solid rgba(255,255,255,0.07)" }}>
              {row.map((cell,j)=>(
...
function Footer({ onNav }) {
  return (
    <footer style={{ background:"#000d28", color:"white", padding:"62px 28px 26px" }}>
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        <div style={{ display:"grid", gridTemplateColumns:"2fr 1fr 1fr 1fr", gap:44, marginBottom:50 }}>
          <div>
